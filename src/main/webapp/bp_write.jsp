...
<body>
	...
	<div class="container">
		<div class="row">
			<form action="bp_writeAction.jsp" method="post" enctype="multipart/form-data">
				<table class="table table-striped"
					...
					<tr>
						<td><input type="text" class="form-control" placeholder="글 제목" name="bpTitle" maxlength="50"></td>
					</tr>
					<tr>
						<td><textarea class="form-control" placeholder="글 내용"name="bpContent" maxlength="2048" style="height: 350px;"></textarea></td>
					</tr>
					<tr>
